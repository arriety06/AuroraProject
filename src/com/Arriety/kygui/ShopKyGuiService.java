...
//                msg.writer().writeByte(0);
    ...
    public List<ItemKyGui> getItemCanKiGui(Player pl) {
        ...
        pl.inventory.itemsBag.stream().filter((it) -> (it.isNotNullItem() && ((it.template.type < 5 && it.template.type >= 0) || it.template.type == 12 || it.template.type == 14 || it.template.type == 30 || it.template.type == 33 || it.template.type == 29))).forEachOrdered((it) -> {
