...
//    );
    ...
    public static final BossData DORAEMON = new BossData(
            ...
            new int[][]{
                {Skill.DRAGON, 7, 100},
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 3000},}, //skill//skill
    ...
    //************************************************************************** Boss nrd
    public static final BossData SP_BROLY = new BossData(
            "Super Broly", //name
            ConstPlayer.XAYDA, //gender
            new short[]{294, 295, 1085, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            200000, //dame
            new int[]{5000}, //hp
            new int[]{0, 1, 2, 3, 4, 5, 7, 8, 9, 10, 14, 15, 16, 17, 5}, //map join
            new int[][]{
                {Skill.KAMEJOKO, 7, 10000},
                {Skill.LIEN_HOAN, 7, 1000}},
            new String[]{}, //text chat 1
    ...
    public static final BossData SO_4_NM = new BossData(
            ...
            1832002, //dame
            new int[]{150000000}, //hp
            new int[]{10, 11, 12, 13, 25, 31, 32, 33, 34}, //map join
            //           new int[]{86}, //map join
            new int[][]{
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.MASENKO, 7, 1000},
    ...
    public static final BossData SO_2_NM = new BossData(
            ...
            new int[][]{
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.THAI_DUONG_HA_SAN, 6, 30000},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
                "|-1|Chán", "|-1|Đại ca Fide có nhầm không nhỉ",
                "|-1|Một mình tao chấp hết tụi bây",
    ...
    public static final BossData SO_1_NM = new BossData(
            ...
            new int[][]{
                ...
                {Skill.TROI, 6, 100000},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
                "|-1|Chán", "|-1|Đại ca Fide có nhầm không nhỉ",
                "|-1|Một mình tao chấp hết tụi bây",
