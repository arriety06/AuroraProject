...
import static com.girlkun.models.boss.BossID.SOI_HEC_QUYN;
import static com.girlkun.models.boss.BossID.SOI_HEC_QUYN_MAX;
...
public class Boss extends Player implements IBossNew, IBossOutfit {
    ...
    public short getHead() {
        ...
        if (effectSkill != null && effectSkill.isMaPhong3) {
            return 1221;
        }
...
//        System.out.println("this status: " + this.bossStatus + " (" + this.id + ")");
    ...
    public void attack() {
        if (Util.canDoWithTime(this.lastTimeAttack, 100) && this.typePk == ConstPlayer.PK_ALL) {
            ...
            try {
                ...
                if (pl == null || pl.isDie() || pl.isNewPet || pl.effectSkin.isVoHinh || pl.isReferee) {
                    return;
                }
    ...
    public void die(Player plKill) {
        if (plKill != null) {
            ...
            if (this.zone.map.mapId == 140 || MapService.gI().isMapMaBu(this.zone.map.mapId)
                ...
                ServerNotify.gI().notify(plKill.name + " vừa tiêu diệt được " + this.name + " ở " + this.zone.map.mapName + " khu vực " + plKill.zone.zoneId + ", mọi người đều ngưỡng mộ..");
            }
        }
    ...
    public void moveTo(int x, int y) {
        ...
        PlayerService.gI().playerMove(this, this.location.x + (dir == 1 ? move : -move), y + (Util.isTrue(3, 100) ? -50 : 0));
    }
    ...
    public void wakeupAnotherBossWhenAppear() {
        Logger.log(Logger.PURPLE, this.name + ":" + this.zone.map.mapName + " khu vực " + this.zone.zoneId + "(" + this.zone.map.mapId + ")\n");
...
//            System.out.println("BOSS " + this.name + " : " + this.zone.map.mapName + " khu vực " + this.zone.zoneId + "(" + this.zone.map.mapId + ")");
    ...
    public void wakeupAnotherBossWhenDisappear() {
        Logger.log(Logger.GREEN, "Boss " + this.name + " vừa bị tiêu diệt\n");
    }
