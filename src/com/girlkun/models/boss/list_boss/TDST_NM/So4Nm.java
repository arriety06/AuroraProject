 ...
 * @author vdin2
 */
public class So4Nm extends Boss {

    public So4Nm() throws Exception {
        super(BossID.SO_4_NM, BossesData.SO_4_NM);
    }
    @Override
    public void reward(Player plKill) {
        int slhndrop = Util.nextInt(10, 20);
        ItemMap caitrang = new ItemMap(this.zone, 429, 1,this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
