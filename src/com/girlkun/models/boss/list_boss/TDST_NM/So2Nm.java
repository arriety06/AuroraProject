 ...
 * @author vdin2
 */
public class So2Nm extends Boss {

    public So2Nm() throws Exception {
        super(BossID.SO_2_NM, BossesData.SO_2_NM);
    }
    @Override
    public void reward(Player plKill) {
        int slhndrop = Util.nextInt(10, 20);
        ItemMap caitrang = new ItemMap(this.zone, 431, 1,this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
