 ...
 * @author vdin2
 */
public class So1Nm extends Boss {

    public So1Nm() throws Exception {
        super(BossID.SO_1_NM, BossesData.SO_1_NM);
    }
    @Override
    public void reward(Player plKill) {
        int slhndrop = Util.nextInt(10, 20);
        ItemMap caitrang = new ItemMap(this.zone, 432, 1,this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
