...
//   
    ...
    public static final int SP_BROLY = -248;
    ...
    public static final int BROLY = -1003002000;
    ...
    public static final int Trom = -255;
    public static final int Trom1 = -261;
    public static final int Trom2 = -270;
    public static final int SO_4_NM = -256;
    public static final int SO_3_NM = -257;
    public static final int SO_2_NM = -258;
    public static final int SO_1_NM = -259;
    public static final int TIEU_DOI_TRUONG_NM = -260;
    ...
    *List Boss DHVT 23
    ...
    public static final int SOI_HEC_QUYN_MAX = -2_147_479_980;// 20 con
    public static final int SOI_HEC_QUYN_BEO = -2_147_480_000;
    public static final int AN_TROM = -2_147_479_950;
    public static final int AN_TROM_MAX = -2_147_479_930;
    public static final int SUPER_BROLY = -2_147_479_500;
    public static final int BROLY_THUONG = -2_147_479_520;

    public static boolean isBossSoiHecQuyn(int id) {
        return (id >= SOI_HEC_QUYN_BEO && id <= SOI_HEC_QUYN_MAX);
    }

    public static boolean isAnTrom(int id) {
        return (id >= AN_TROM && id <= AN_TROM_MAX);
    }
    public static boolean isBrolyOrSuper(int id) {
        return (id >= -2_147_479_520 && id <= -2_147_479_500 + 20);
    }
}
