...
public class Pet extends Player {
    ...
    public void update() {
        try {
            if (master == null || master.zone == null || !master.isPl()) {
                return;
            }
...
//    
    ...
    public short getHead() {
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            return 297;
        } else if (this.inventory != null && this.inventory.itemsBody != null && inventory.itemsBody.get(5).isNotNullItem()) {
    ...
    public short getBody() {
        ...
        if (this.inventory != null && this.inventory.itemsBody != null && inventory.itemsBody.get(0).isNotNullItem()) {
    ...
    public short getLeg() {
        ...
        if (this.inventory != null && this.inventory.itemsBody != null && inventory.itemsBody.get(1).isNotNullItem()) {
    ...
    private void updatePower() {
        try {
            if (this.playerSkill != null && this.nPoint != null) {
