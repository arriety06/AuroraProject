...
public class Map implements Runnable {
    ...
    public Map(int mapId, String mapName, byte planetId,
        ...
        try {
            ...
            System.out.println("Lỗi map: " + mapName);
        }
    ...
    public void run() {
        while (true) {
            try {
                ...
                for (DoanhTrai doanhtrai : DoanhTraiService.gI().doanhTrais) {
                    if (doanhtrai != null && doanhtrai.getClan() != null) {
                        doanhtrai.update();
                    }
                }
                for (BanDoKhoBau bando : BanDoKhoBauService.gI().BDKBs) {
                    if (bando != null && bando.getClan() != null) {
                        bando.update();
                    }
                }
