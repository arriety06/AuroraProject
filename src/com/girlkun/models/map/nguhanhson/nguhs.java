...
public class nguhs {
    ...
    public static final byte HOUR_OPEN_MAP_NHS = 6;
    public static final byte MIN_OPEN_MAP_NHS = 0;
    public static final byte SECOND_OPEN_MAP_NHS = 0;

    public static final byte HOUR_CLOSE_MAP_NHS = 18;
    ...
    public void update(Player player) {
        if (player.isPl() && player != null) {
            try {
                ...
                ex.printStackTrace();
                System.out.println("Lỗi update ở class Nguhs");
            }
        }
    }
}
