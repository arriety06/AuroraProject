...
public class ItemTime {
    ...
    public static final int TIME_MAY_DO_CA = 1800000;
    public static final int TIME_MAY_DO_TOM = 1800000;
    public static final int TIME_MAY_DO_OC = 1800000;
    public static final int TIME_MAY_DO_CUA = 1800000;
    ...
    public long TimeMayDoCua;

    public boolean isUseMayDoCa;
    public long TimeMayDoCa;

    public boolean isUseMayDoOc;
    public long TimeMayDoOc;

    public boolean isUseMayDoTom;
    public long TimeMayDoTom;
    ...
    public long lastTimeUseMayDo2;//lastime de chung 1 cai neu time = nhau
