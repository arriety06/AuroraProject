package com.girlkun.models.DragonBallNamec;
...
public class NgocRongNamecService implements Runnable {
    ...
    public long timedu7v;
    public long timechouoc = 300000;
...
//                System.out.println(itemMap.itemTemplate.name+"[" + zone.map.mapId+ "-" + zone.zoneId+"]");
    ...
    public String getNameMap(Player pl, int id, short temp) {
        try {
