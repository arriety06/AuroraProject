...
public class DataGame {
    ...
    public static void sendVersionGame(ISession session) {
        Message msg;
        try {
...
//            e.printStackTrace();
    ...
    //vcData
    public static void updateData(ISession session) {
...
//            e.printStackTrace();
    ...
    //vcSkill
    public static void updateSkill(ISession session) {
...
//            e.printStackTrace();
    ...
    public static void sendDataImageVersion(ISession session) {
        Message msg;
        try {
            msg = new Message(-111);
            msg.writer().write(FileIO.readFile("data/girlkun/data_img_version/x" + session.getZoomLevel() + "/img_version"));
            session.doSendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
//            e.printStackTrace();
...
//            e.printStackTrace();
    ...
    public static void effData(ISession session, int id, int... idtemp) {
        if (id >= 201 && id <= 207) {
        ...
        Message msg;
        try {
            byte[] effData = FileIO.readFile("data/girlkun/effect/x" + session.getZoomLevel() + "/data/DataEffect_" + idT);
            byte[] effImg = FileIO.readFile("data/girlkun/effect/x" + session.getZoomLevel() + "/img/ImgEffect_" + idT + ".png");
            msg = new Message(-66);
...
//            e.printStackTrace();
    ...
    public static void sendItemBGTemplate(ISession session, int id) {
        Message msg;
        try {
            byte[] bg_temp = FileIO.readFile("data/girlkun/item_bg_temp/x" + session.getZoomLevel() + "/" + id + ".png");
            msg = new Message(-32);
            msg.writer().writeShort(id);
            if (bg_temp != null) {
...
//            e.printStackTrace();
    ...
    public static void sendDataItemBG(ISession session) {
        Message msg;
        try {
...
//            e.printStackTrace();
    ...
    public static void sendIcon(ISession session, int id) {
        Message msg;
        try {
            byte[] icon = FileIO.readFile("data/girlkun/icon/x" + session.getZoomLevel() + "/" + id + ".png");
            msg = new Message(-67);
...
//            e.printStackTrace();
    ...
    public static void sendSmallVersion(ISession session) {
        Message msg;
        try {
            msg = new Message(-77);
            byte[] data = FileIO.readFile("data/girlkun/data_img_version/x" + session.getZoomLevel() + "/img_version");
            if (data != null) {
...
//            e.printStackTrace();
    ...
    public static void requestMobTemplate(ISession session, int id) {
        Message msg;
        try {
            byte[] mob = FileIO.readFile("data/girlkun/mob/x" + session.getZoomLevel() + "/" + id);
            if (mob != null) {
                msg = new Message(11);
                if (id != 85 && id != 87) {
    ...
    public static void sendTileSetInfo(ISession session) {
        Message msg;
        try {
            msg = new Message(-82);
...
//        }
    ...
    //data vẽ map
    public static void sendMapTemp(ISession session, int id) {
        Message msg;
        try {
            msg = new Message(-28);
...
//            e.printStackTrace();
            Logger.logException(DataGame.class, e);
            Logger.log("Lost file: data/girlkun/map/tile_map_data/" + id);
...
//            e.printStackTrace();
    ...
    public static void sendImageByName(ISession session, String imgName) {
        Message msg;
        try {
            msg = new Message(66);
            msg.writer().writeUTF(imgName);
            msg.writer().writeByte(Manager.getNFrameImageByName(imgName));
            byte[] data = FileIO.readFile("data/girlkun/img_by_name/x" + session.getZoomLevel() + "/" + imgName + ".png");
...
//            e.printStackTrace();
    ...
    public static void sendSizeRes(ISession session) {
        Message msg;
        try {
            msg = new Message(-74);
            msg.writer().writeByte(1);
            msg.writer().writeShort(new File("data/girlkun/res/x" + session.getZoomLevel()).listFiles().length);
            session.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
//            e.printStackTrace();
    ...
    public static void sendRes(ISession session) {
        Message msg;
        try {
            for (final File fileEntry : new File("data/girlkun/res/x" + session.getZoomLevel()).listFiles()) {
...
//            e.printStackTrace();
    ...
    public static void sendLinkIP(ISession session) {
        Message msg;
        try {
            msg = new Message(-29);
            msg.writer().writeByte(2);
