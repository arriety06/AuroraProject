...
public class ItemData {
    ...
    //------------------------------------------------------ start update client
    public static void updateItem(ISession session) {
...
//        updateItemTemplate(session, 1500, Manager.ITEM_TEMPLATES.size());
    ...
    private static void updateItemOptionItemplate(ISession session) {
        Message msg;
        try {
            msg = new Message(-28);
    ...
    private static void updateItemTemplate(ISession session, int count) {
        Message msg;
        try {
            msg = new Message(-28);
            msg.writer().writeByte(8);
    ...
    private static void updateItemTemplate(ISession session, int start, int end) {
        Message msg;
        try {
            msg = new Message(-28);
            msg.writer().writeByte(8);
