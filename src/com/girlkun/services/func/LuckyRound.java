...
public class LuckyRound {
    ...
    public void openCrackBallUI(Player pl, byte type) {
        if ((pl.inventory.itemsBoxCrackBall.size() - InventoryServiceNew.gI().getCountEmptyListItem(pl.inventory.itemsBoxCrackBall) < 56)) {
            ...
            Service.gI().sendThongBao(pl, "Rương phụ đã đầy!");
        }
    }
