...
//            addListMapCapsule(pl, list, getMapCanJoin(pl, i, 0));
//        }
        return list;
    }
    ...
    public boolean isMapUpManhTS(Map map) {
        int mapId = map.mapId;
        return mapId == 155 || mapId >= 160 && mapId <= 163;
    }
    ...
    public boolean ismappvphonchien(int mapId) {
        return mapId >= 164 && mapId <= 168;// id map từ đau đên đau
    }
//    147	Sa Mạc
//148	Lâu đài Lychee
//149	Thành phố Santa
