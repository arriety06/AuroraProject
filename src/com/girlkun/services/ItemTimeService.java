...
public class ItemTimeService {
    ...
    //tự sửa lấy thích hiện gì thì hiện
    //gửi cho client
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseAnDanh) { // id icon 2760
        ...
        if (player.itemTime.isUseMayDoCua) {
            sendItemTime(player, 5222, (int) ((TIME_MAY_DO_CUA - (System.currentTimeMillis() - player.itemTime.TimeMayDoCua)) / 1000));
        }
        if (player.itemTime.isUseMayDoCa) {
            sendItemTime(player, 5222, (int) ((TIME_MAY_DO_CA - (System.currentTimeMillis() - player.itemTime.TimeMayDoCa)) / 1000));
        }
        if (player.itemTime.isUseMayDoTom) {
            sendItemTime(player, 5222, (int) ((TIME_MAY_DO_TOM - (System.currentTimeMillis() - player.itemTime.TimeMayDoTom)) / 1000));
        }
        if (player.itemTime.isUseMayDoOc) {
            sendItemTime(player, 5222, (int) ((TIME_MAY_DO_OC - (System.currentTimeMillis() - player.itemTime.TimeMayDoOc)) / 1000));
        }
    }
