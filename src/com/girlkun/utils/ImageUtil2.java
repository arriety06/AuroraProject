...
import static com.girlkun.utils.ImageUtil.saveImage;
...
public class ImageUtil2 {
    ...
    public static void readmob(int zoomlv, int mob) {
        ...
        byte[] data = null;
        try {
            DataInputStream dis = new DataInputStream(new FileInputStream("data/girlkun/beo/x" + zoomlv + "/" + mob));
            ...
            saveImage(oriImage, "C:\\Users\\HT\\Desktop\\read mob\\x" + zoomlv, mob + "");
            if (typeRead != 0) {
...
//    }
    ...
    public static void readEff(int id, int zoom) {
        try {
            String path1 = "C:\\Users\\PC\\Desktop\\NRO\\data\\girlkun\\effect_data\\x2\\";
            String path2 = "C:\\Users\\PC\\Desktop\\NRO\\data\\girlkun\\effect_data\\data\\";
             DataInputStream dis = new DataInputStream(new FileInputStream("data/girlkun/effect_data/x" + zoom + "/" + id));
    ...
    private static void readDataEffect(byte[] data, int idEffect, int zoom, BufferedImage oriImage) {
        try {
            ...
            for (int i = 0; i < nFrame; i++) {
                ...
                g.dispose();
                saveImage(trimImage(frame), "C:\\Users\\PC\\Desktop\\NRO\\data\\girlkun\\eff\\x" + zoom + "\\" + idEffect, i + "");
            }
