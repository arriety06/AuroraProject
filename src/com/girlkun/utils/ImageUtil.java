...
//            System.out.println("type read: " + typeRead);
            ...
            JOptionPane.showMessageDialog(null, null, "", zoomlv, new ImageIcon(oriImage));
            saveImage(oriImage, "C:\\Users\\HT\\Desktop\\mob\\x" + zoomlv, mob + "");
            if (typeRead != 0) {
...
//                    System.out.println("mob: " + mobId);
                ...
                //từng bộ phận
                saveImage(imagesInfo[i], "C:\\Users\\HT\\Desktop\\mob\\imginfo\\x" + zoomLevel
                        + "\\" + mobId, mobId + "_" + id);
            }
            ...
            for (int i = 0; i < nFrame; i++) {
                ...
                saveImage(trimImage(frame), "C:\\Users\\HT\\Desktop\\mob\\frame\\x" + zoomLevel
                        + "\\" + mobId, mobId + "_" + i);
            }
...
//                System.out.println("frame id: " + frameId);
            ...
            ImageOutputStream output
                    = new FileImageOutputStream(new File("C:\\Users\\HT\\Desktop\\mob\\framegif\\" + mobId + ".gif"));
    ...
    private static void readDataEffect(byte[] data, int idEffect, int zoom, BufferedImage oriImage) {
        try {
            ...
            for (int i = 0; i < nFrame; i++) {
                ...
                g.dispose();
                saveImage(trimImage(frame), "C:\\Users\\HT\\Desktop\\effect_\\x" + zoom + "\\" + idEffect, i + "");
            }
