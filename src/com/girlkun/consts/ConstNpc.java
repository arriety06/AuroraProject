...
public class ConstNpc {
    ...
    public static final String SU_KIEN_HUNG_VUONG = "Có 2 nguyên liệu chính trong sự kiện là \n Dưa Hấu và Cà Rốt\n"
            + "Sự kiện anh em up đệ tử ở bất kỳ Map nào\n Có tỉ lệ rơi ra Dưa hấu thấp hơn Cà Rốt\n"
            + "Dưa Hấu sẽ đổi được món đồ vĩnh viên \n còn Cà Rốt đổi ra Item Hạn Sửa Dụng!\n"
            + "Bạn có thể sửa dụng thỏi vàng để mua\n Dưa Hấu ở Santa\n"
            + "Chúc Anh Em Chơi Sự Kiện Vui Vẻ. \b|2| Sự Kiện Chỉ Áp Dụng Cho Đệ Tử!";
    public static final String MENU_SIEU_HANG = "Giải đấu thể hiện sự đẳng cấp thực sự\bCác trận đấu được diễn ra bất kể ngày đêm\bBạn hãy tham gia để nâng cao mức hạng\bvà nhận được giải thưởng mỗi ngày nhé!\n"
            + "Cơ cấu giải thưởng như sau!\b(chốt và trao giải thưởng lúc 4h sáng)\bTop 1-10 thưởng 100 hồng ngọc\bTop 10-100 thưởng 50 hồng ngọc\bTop 100-1000 thưởng 20 hồng ngọc";
    ...
    public static final byte TORI = 74;
    public static final byte KHI_DAU_MOI = 75;
    public static final byte FURRY = 77;
    public static final byte ADMIN = 76;
    public static final byte NOEL = 98;
    public static final byte LUCKY_NUMER = 103;
    ...
    // menu Whist 
    public static final int OPEN = 1906;
    public static final int CAN_OPEN = 2000;
    ...
    public static final int SHOPBILL = 501;
    ...
    public static final int MENU_AP_TRUNG = 507;
    public static final int MENU_NANG_CAP_LINH_THU = 507;
    ...
    public static final int UP_TOP_ITEM = 523;
    ...
    public static final int CONFIRM_SPEED_EGG = 504;
    ...
    public static final int MENU_NANG_KHI = 691;
    public static final int CALL_BOSS = 1998;
